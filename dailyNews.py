...
for url in headlineUrls:
    ...
    try:
        ...
        article['Topic 5'] = ''
    try:
        title = soup.select_one("[data-entityid='more-on-this-story#1'] span").text

        urlement = soup.select_one('[data-entityid="more-on-this-story#1"] a')
        article['Related Story 1'] = title + ' - https://www.bbc.co.uk' + urlement['href']
    except:
        article['Related Story 1'] = ''    
    try:
        title = soup.select_one("[data-entityid='more-on-this-story#2'] span").text

        urlement = soup.select_one('[data-entityid="more-on-this-story#2"] a')
        article['Related Story 2'] = title + ' - https://www.bbc.co.uk' + urlement['href']
    except:
        article['Related Story 2'] = ''
    try:
        title = soup.select_one("[data-entityid='more-on-this-story#3'] span").text

        urlement = soup.select_one('[data-entityid="more-on-this-story#3"] a')
        article['Related Story 3'] = title + ' - https://www.bbc.co.uk' + urlement['href']
    except:
        article['Related Story 3'] = ''    
    try:
        title = soup.select_one("[data-entityid='more-on-this-story#'] span").text

        urlement = soup.select_one('[data-entityid="more-on-this-story#4"] a')
        article['Related Story 4'] = title + ' - https://www.bbc.co.uk' + urlement['href']
    except:
        article['Related Story 4'] = ''
    try:
        title = soup.select_one("[data-entityid='more-on-this-story#5'] span").text

        urlement = soup.select_one('[data-entityid="more-on-this-story#5"] a')
        article['Related Story 5'] = title + ' - https://www.bbc.co.uk' + urlement['href']
    except:
...
input('Press any key to close and save results to CSV: \n')
